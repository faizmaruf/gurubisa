...
class M_progres extends CI_Model
{
    ...
    function getIsdoneProgres($id_materi)
    {
        $hsl = $this->db->query("SELECT progres.is_done FROM materi JOIN progres ON progres.id_materi = materi.id_materi WHERE progres.id_materi=$id_materi");
